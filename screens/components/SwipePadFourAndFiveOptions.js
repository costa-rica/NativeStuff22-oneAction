...
export default function SwipePadFourAndFiveOptions(props) {
  // Dynamic Styles
  const styleVwOuter = {
  ...
  return (
    <View style={[props.styleVwMainPosition, styleVwOuter]}>
      ...
      >
        <Polygon
          points={`0,0 0,${props.circleRadiusOuter} ${
            props.circleRadiusOuter
          },${props.circleRadiusOuter / 1000}`}
